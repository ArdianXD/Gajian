...
<body>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="text-center">
                <a href="kalkulasi.php" class="btn-get-started scrollto">Hitung Ulang</a>
            </div>
        </div>
    </section>
    <!-- ======= End Hero Section ======= -->
    ...
    <section id="counts" class="counts section-bg">
        <div class="section-title">
          <h2>Total Gaji</h2>
          <?php echo $_POST["nama"];?> | <?php echo  $_POST["nik"];?>
        </div>
      <div class="container">
        ...
        <div class="row justify-content-end">
          ...
          <div class="col-12 d-md-flex align-items-md-stretch">
            <div class="count-box">
                <p>Rp.</p>
              <span data-purecounter-start="0" data-purecounter-end=<?php total_gaji(); ?> data-purecounter-duration="2" class="purecounter"></span>
            </div>
          </div>
        </div>
      </div>
